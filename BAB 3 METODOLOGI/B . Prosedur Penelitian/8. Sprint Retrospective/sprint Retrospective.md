...
Penelitian ini mengimplementasikan sistem informasi pendaftaran untuk Kursus Persiapan Perkawinan, selanjutnya disebut KPP, di Biara Loresa SCJ SP3 pada proyek aplikasi berbasis Laravel. Tabel berikut menyusun rumusan *Sprint Retrospective* per *Sprint* sesuai dokumen *Sprint Planning* dan *Sprint Backlog*. Tema refleksi mengikuti modul yang menjadi fokus pada iterasi bersangkutan tanpa menggantikan artefak dari *Sprint Review* maupun tahap *Increment Development & Testing*. Kolom **Sprint** memuat nama iterasi. Kolom **Fokus refleksi** memuat pokok tinjauan cara kerja selama iterasi. Kolom **Perbaikan** memuat penyepakatan perbaikan proses yang akan diterapkan pada iterasi berikutnya. Rentang tanggal tiap *Sprint* mengacu pada dokumen *Sprint Planning*.

## Tabel Sprint Retrospective


| Sprint   | Fokus refleksi                                                                                                                                                     | Kesepakatanan                                                                                                                         |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
