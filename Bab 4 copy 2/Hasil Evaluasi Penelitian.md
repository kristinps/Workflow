...
**Lampiran per responden:** lembar jawaban lengkap berada pada folder `Bab 4/Evaluasi SUS/responden/` berkas `R-01.md` hingga `R-10.md`.
...
Rentang interpretasi mengacu pada klasifikasi umum SUS: di bawah 51 tidak dapat diterima; 51–73 marginal hingga baik; di atas 73 baik hingga sangat baik, dengan penyesuaian kutipan pada landasan metode. Skor per orang dihitung dari lembar jawaban pada lampiran `Evaluasi SUS/responden/`.
